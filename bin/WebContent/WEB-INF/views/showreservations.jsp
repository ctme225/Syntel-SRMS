            ...
            <div class="row" >
                <div class="col-2 text-center">
                	<div class="row center">
                		<div class="dropdown">
                    		<button class="btn btn-primary btn-sm dropdown-toggle loc-drop" style="width:240px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<<<<<<< HEAD
							<div class="dropdown fc-event">
	                        	<button class="btn btn-primary btn-sm dropdown-toggle" style="width:100%;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
=======
							<div class="dropdown">
...
>>>>>>> c8f1647b73a66c977e59c2aa7e3df89c77db04be
	                            	${defaultResType}
	                        	</button>
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <button type="button" class="close" aria-label="Close">
		          <button type="button" class="btn btn-primary deleteButton">Delete this Booking</button>
		          	<div id="deleteBooking" style="display: none">
					  <div class="are-you-sure-delete">
					  	<p>Are you sure you want to delete this booking??</p>
					  	<div class="row">
					  		<div class="col">
						  		<button type="button" class="btn btn-primary confirmDeleteButton">Confirm</button>
						  	</div>
						</div>
					  </div>
					</div>
